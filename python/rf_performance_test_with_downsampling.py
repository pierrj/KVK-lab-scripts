...
df_srf.to_csv(output_name + '.srf_downsample_test_all_tes.csv')
df_brfc.to_csv(output_name + '.brfc_downsample_test_all_tes.csv')
df_smotesrf.to_csv(output_name + '.smotesrf_downsample_test_all_tes.csv')
df_srf_balanced.to_csv(output_name + '.srf_balanced_downsample_test_all_tes.csv')
df_srf_balanced_subsample.to_csv(output_name + '.srf_balanced_subsample_downsample_test_all_tes.csv')