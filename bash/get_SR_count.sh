#!/bin/bash
samtools view -f 81 -F 4 -q 1 sorted.mergedandpe.${1}_bwamem.bam ${2} > tmp.reverseread1.mergedandpe.${2}_bwamem.sam
samtools view -f 145 -F 4 -q 1 sorted.mergedandpe.${1}_bwamem.bam ${2} > tmp.reverseread2.mergedandpe.${2}_bwamem.sam
samtools view -f 65 -F 20 -q 1 sorted.mergedandpe.${1}_bwamem.bam ${2} > tmp.forwardread1.mergedandpe.${2}_bwamem.sam
samtools view -f 129 -F 20 -q 1 sorted.mergedandpe.${1}_bwamem.bam ${2} > tmp.forwardread2.mergedandpe.${2}_bwamem.sam
