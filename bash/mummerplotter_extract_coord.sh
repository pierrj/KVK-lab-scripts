...
while read plot; do
    ...
    then
        ...
        /global/scratch/pierrj/mummer_4/bin/show-coords ${SUBDIR_TMP}/${plot}.delta | tail -n+6 | awk -v OFS='\t' '{print $1, $2, $4, $5, $12, $13}' > ${output_realpath}/${ref}_v_${quer}_${plot}.processed.coords
    fi
